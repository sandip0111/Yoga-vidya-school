import { Component,Inject, Renderer2, ElementRef, ViewEncapsulation } from '@angular/core';
...
export class CourseComponent {
  ...
  constructor(private webapiService: WebapiService, private _activatedRoute: ActivatedRoute, private router: Router, private title: Title, private meta: Meta, protected sanitizer: DomSanitizer,private _renderer2: Renderer2,@Inject(DOCUMENT) private _document: Document){
