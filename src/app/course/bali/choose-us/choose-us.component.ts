  ...
  constructor(
    ...
    if (this.slug == this.routEnum.bali200) {
      ...
      this.chooseData = {
        ...
        list: [
          'Optimal Blend of Heritage and Contemporary Practices: Effortlessly combine ancient wisdom of yoga with present-day trends and practices and integrate these seamlessly in today’s lifestyle',
          'Exhaustive Curriculum: An extensive syllabus with dedicated modules on physical asana practice, immersive pranayama and meditation and ancient philosophy learnings',
          'Unflinching Support of Yoga Masters: Learn yoga from yoga experts who are graduates from renowned institutions. The yoga teachers at Yoga Vidya School are masters in their niche yoga departments and dedicated towards offering you authentic and traditional yoga practices.',
          'Conducive Environment: At Yoga Vidya School, yoga aspirants can look forward to a conducive and nurturing environment for gaining yogic wisdom of the body, mind and soul.',
      ...
      this.chooseData = {
        ...
        content:
          'Yoga Vidya School believes in offering best-in-class 200 Hour Yoga teacher training in Kerala. Helmed by Acharya Prashant Jakhmola, all Yoga TTC programs of Yoga Vidya School are certified by Yoga Alliance, USA entailing quality training in yoga. We at Yoga Vidya School enlist a multitude of reasons for selecting us as your place of choice to learn yoga.',
        list: [
          'Ideal Blend of Heritage and Contemporary Practices:  Effortlessly combines traditional  knowledge of yoga with present day scientific knowledge and integrate these in modern lifestyle',
          'Detail-Oriented Curriculum: An exhaustive curriculum with different chapters and modules dedicated to various formats of yoga asanas, profoundly immersive  meditation and pranayama practices , evolution of yoga and classical philosophy lessons',
          'Committed Yoga Masters: Practice various yoga asanas and gain deep knowledge of different yogic practices guided by yoga instructors who are yoga graduates from renowned yoga shalas and Ashrams. Yoga Vidya School prides itself in having a team of experts in niche yoga practices and dedicated towards offering you  authentic knowledge on yoga.',
          'Nurturing Environment:  Yoga Vidya School offers a nurturing and supportive environment to aspiring yoga teachers that enhances learning outcomes',
          'Online Access to Courses: Enhance your yoga knowledge and deepen your asana  practice by  accessing different yoga courses made available online.',
        ],
      };
      ...
      this.chooseData = {
        ...
        secondImage:
          'https://my-s3-images-bucket.s3.amazonaws.com/images/choose2_uumhfx.jpg',
        content:
          'Yoga Vidya School offers top-notch 300 Hour Yoga teacher training in Kerala. Spearheaded by Acharya Prashant Jakhmola, Yoga Vidya School is a Yoga Alliance certified yoga institution offering world-class education in yoga. We give you a number of reasons for choosing us as your trusted partner in learning yoga.',
        list: [
          'Optimal Blend of Tradition and Present-Day Practices: Seamlessly blend traditional knowledge of yoga with modern practices and sync them in today’s lifestyle.',
          'Intensive  Curriculum: A comprehensive syllabus with different chapters and modules dedicated to physical asana practice,  pranayama and meditation and age-old philosophical wisdom',
          'Committed Yoga Masters: Yoga Vidya School has a team of well regarded yoga teachers  who are masters in  niche yoga skills and committed towards providing a truly authentic  yoga experience.',
          'Conducive Environment: Yoga Vidya School offers a supportive and conducive environment to learn and ace various Yogic Practices.',
          'Access to Online Courses: Enrich your  knowledge of ancient yogic practices by  accessing a plethora of online yoga  courses.',
        ],
      };
      ...
      this.chooseData = {
        ...
        list: [
          'Optimal Mix of Tradition and Contemporary Practices:  Seamlessly blends classical  knowledge of yoga with modern day practices  and introduce these in today’s lifestyle',
          'Updated Curriculum: An updated  curriculum that includes various  modules dedicated to Hatha and Ashtanga Vinyasa practices,  immersive pranayama and meditation practices, origins and history of yoga along with core yogic ideas and concepts.',
          'Dedicated Yoga Teachers: Get introduced to Hatha and Ashtanga Vinyasa yoga asanas and gain knowledge of other practices in yoga guided by expert yoga teachers. Yoga Vidya School has  a team of yoga teaching faculties who are experts in their niche yoga departments and committed to offering you knowledge in authentic yoga practices.',
          'Supportive Environment:  Yoga Vidya School offers an amiable and supportive environment to aspiring yogis and yoginis that ensure positive learning outcomes',
          'Access to Online Courses: Gain fundamental and foundational yoga knowledge  by  getting access to different online yoga courses.',
        ],
      };
    } else {
      this.noContent = true;
