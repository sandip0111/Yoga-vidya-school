...
export class IncludesComponent implements OnInit {
  ...
  not_includes: item[] = [];
  image: any =
    'https://my-s3-images-bucket.s3.amazonaws.com/images/inschool-yoga_retreat_doaezs.jpg';
  courseFee: any = '';
  courseText: any = '';
  ...
  constructor(private activatedRoute: ActivatedRoute, private router: Router) {
    ...
    if (this.slug == '200-hour-yoga-teacher-training-in-bali') {
      ...
      this.image =
        'https://my-s3-images-bucket.s3.amazonaws.com/images/FERN8247_mp1qxh.jpg';
    } else if (
