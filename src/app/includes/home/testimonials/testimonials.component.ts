      ...
      this.testimonials = [
        {
          ...
          name: 'Neha',
          description:
            'Prashant ji is an awesome guru. He takes utmost care while teaching so that anyone with little yoga experience can understand. At the same time he will take care of highly experienced yogastudents',
          rating: 5,
        },
        {
